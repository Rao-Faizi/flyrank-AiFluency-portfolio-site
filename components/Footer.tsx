export default function Footer() {
  return (
    <footer className="bg-foreground text-white py-12 px-4 border-t border-gray-800">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        
        {/* FlyRank Badge */}
        <div className="flex-shrink-0">
          <a
            href="https://internship.flyrank.ai/verify?id=FR-D1-T668H-R789R&first_name=Muhammad%20Faizan"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Verify this FlyRank AI Internship credential"
            style={{
          ...
          >
            ...
            >
              ...
              >Front-end AI Engineering</span>
            </span>
            <span
              style={{
                margin: "0",
                padding: "6px 12px",
                border: "1px solid rgba(84,227,153,0.25)",
            ...
            >
              ...
              ><circle cx="12" cy="12" r="10" stroke="#54E399" strokeWidth="1.5" /><path d="M7.9 12.3l2.8 2.8 5.4-5.8" stroke="#54E399" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>Verify
            </span>
          </a>
        </div>
